# 🔐 Настройка SSH-туннеля для 3x-UI API

Этот документ описывает, как настроить безопасный SSH-туннель для доступа к 3x-UI API вместо использования самоподписанных SSL-сертификатов.
